...
// gdp->adp boundary: mu=1 delta=1e-15 should hit boundary
var gdpToAdpBound = PrivacyLib.convert("gdp", { mu: 1 }, "adp", { delta: 1e-15 });
assert(gdpToAdpBound.boundaryHit === "upper",
  "gdp->adp with delta=1e-15 should hit upper boundary");
